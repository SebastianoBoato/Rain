...
public class FillingPredictionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WeatherUtils.getFillingPredictions(db, user, todayWeather, new OneElementCallback<List<FillingPredictionItem>>() {
            @Override
            public void onSuccess(List<FillingPredictionItem> fillingPredictionItems) {
                ...
                binding.predictionRecyclerView.setAdapter(new PredictionAdapter(getApplicationContext(), fillingPredictionItems));
            }
